...
I will include a few more readings here that would be good to read. I also encourage everyone to take some time to review any material from previous weeks that felt unclear or unresolved. This review of past weeks is your only exercise for this week.\\

For the papers listed below, I don't intend to overwhelm you with a bunch of complicated readings to get through, but rather I think it would be productive for you to have some more exposure. As such, I don't expect you to go through these papers as thoroughly as in past weeks (with the exception of the first reading), and I encourage you to first read for a higher-level understanding of the general ideas without necessarily getting to bogged down in too many details (unless you'd like to).
...
\begin{reading}
Read about another commonly-used method of organizing complicated security proofs that introduces the background for the Universal Composability (UC) framework in:\\
...
Some additional interesting but super optional reading includes (you can find these through searching the web or asking me for pdfs)
\begin{itemize}
\item Simple Three-Round Multiparty Schnorr Signing with Full Simulatability - Yehuda Lindell
\item Optimizing and Implementing Fischlin's Transform for UC-Secure Zero Knowledge - Yi-Hsiu Chen and Yehuda Lindell
\item Fully Adaptive FROST in the Algebraic Group Model From Falsifiable Assumptions - Ruben Baecker, Paul Gerhart, Davide Li Calsi, Luigi Russo, Dominique Shr\"{o}der, Arkady Yerukhimovich
\end{itemize}
